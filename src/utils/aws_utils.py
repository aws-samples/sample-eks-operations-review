    ...
    def get_cluster_details(self):
        ...
        try:
            ...
            cluster_info['cluster'] = {
                ...
                'region': self.region,
                'created_at': cluster_data.get('createdAt', 'N/A'),
                'vpc_id': cluster_data['resourcesVpcConfig'].get('vpcId', 'N/A'),
                'endpoint_public': cluster_data['resourcesVpcConfig'].get('endpointPublicAccess', False),
                'endpoint_private': cluster_data['resourcesVpcConfig'].get('endpointPrivateAccess', False)
            }
            return cluster_info
