...
from .subprocess_security import secure_subprocess_run  # nosec B404 - secure wrapper used
...
class KubernetesClient:
    ...
    def _update_kubeconfig(self):
        ...
        try:
            ...
            logger.warning(f"Error while updating kubeconfig: {e}")
            raise Exception(f"Error while updating kubeconfig: {e}")
        except Exception as e:
    ...
    def apply_manifest(self, manifest_yaml):
        ...
        try:
            ...
            result = secure_subprocess_run([kubectl_cmd, "apply", "-f", temp_file_path], timeout=60)
            ...
            logger.warning(f"Error while applying Kubernetes manifest: {e}")
            raise Exception(f"Error while applying Kubernetes manifest: {e}")
        except Exception as e:
